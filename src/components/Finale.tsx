...
const Finale = () => {
  ...
  const marqueeTags = [
    "NANCY MARGARET B 🚀",
    "Computer Science Student | CS & BS",
    "Hackathon Organizer | AI Enthusiast",
    "Designing Digital Solutions with Precision",
  ];
  ...
  return (
    <section className="relative w-full bg-white border-t-8 border-black pt-20 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 py-20 flex flex-col items-center">
        ...
        <div className="grid grid-cols-2 gap-4 w-full max-w-2xl mb-24">
